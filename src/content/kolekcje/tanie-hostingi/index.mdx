...
Błyskawiczne aktualizacje strefy dns, ochrona przed botami, cache, ssl, statystyki, hosting statycznych stron, uruchamianie kodu serverless to tylko część korzyści jakie oferuje **cloudflare** zupełnie za darmo. Nie czekaj i już teraz przenieś strefę DNS swoich domen na cloudflare. [Tutaj kiedyś wrzucę poradnik](../poradniki/)
