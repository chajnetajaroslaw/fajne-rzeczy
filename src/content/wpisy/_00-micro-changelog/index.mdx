...
[Giscus](https://giscus.app) leverages Github discussions to act as a comments system. To get Giscus working on your own website, see [here](/wpisy/01-getting-started#deploy-the-site).
...
- Add pagination to the bottom of wpisy posts
- Create 404 page
